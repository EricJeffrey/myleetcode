...
ElTetris.prototype.play = function () {
  var piece = this.getTenNextPiece();
...
ElTetris.prototype.getTenNextPiece = function () {
  ...
  let shape = ['I', 'L', 'J', 'T', 'O', 'S', 'Z'][tmpbrickRaw.shapeIndex]
  ...
  // console.log(shape);
  let which = ten2elmap[tmpbrickRaw.shapeIndex];
  return PIECES[which];
};
